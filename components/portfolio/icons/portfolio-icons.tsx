...
export function ArrowUpRightIcon({ opacity }: { opacity?: string }) {
  return (
    <svg className="icon" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path
...
export function CertificateNavIcon() {
  return (
    <svg className="icon" viewBox="0 0 16 16" fill="none" aria-hidden="true">
...
export function InstagramIcon({ idSuffix }: { idSuffix: string }) {
...
export function GitHubSocialIcon() {
  return (
